...
void GameScene::load()
{
	...
	// instantiate prefabs but dont save reference as unused elsewhere here.
	scene_root->addChild(pref->InstantiatePrefab("P_CharacterFrame"));
	scene_root->addChild(pref->InstantiatePrefab("P_LampManager", 665, 125));
	scene_root->addChild(pref->InstantiatePrefab("P_Desk", 10, 385));
